...
import { CompareDropDownProps } from '@/types/product/product';
import { BEDGE_COLORS } from '@/constants/products';
import useCompareDropdown from '@/hooks/useCompareDropdown';
