 ...
 * shouldRender 인자로 들어온 condition대신 렌더링 조건문에 사용합니다,
 * animationTrigger 해당 요소가 마운트 될때와 언마운트 될때의 애니메이션을 효과를 줄때 사용할 렌더링 조건문에 사용합니다,
 * handleAnimationEnd 애니메이션을 적용할 요소의 onAnimationEnd 어트리뷰트로 걸어줄 함수입니다.
 * ]
 */
