...
const ProductCard = ({
  ...
  return (
    <Link href={`/detail/${id}`}>
      <div className="hover:border-gradient-custom group cursor-pointer rounded-[8px] border border-[#353542] bg-[#252530] px-[10px] py-[10px] md:py-[20px] xl:rounded-[12px] xl:px-[20px] xl:py-[25px]">
